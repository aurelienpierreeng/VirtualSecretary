...
# Build the model
model = Classifier(training_set, 'sentences_classifier.joblib', False)

# Classify test stuff
print(model.classify("Do you have time to meet at 5pm ?"))
print(model.classify_many(["Come with me", "Nope"]))
print(model.prob_classify_many(["Come with me", "Nope"]))
